...
return new class extends Migration
{
    ...
    {
        $procedure = "
            DROP PROCEDURE IF EXISTS get_candidates_votes_by_seccion;
            CREATE DEFINER=`root`@`localhost` PROCEDURE `get_candidates_votes_by_seccion`(IN election_id int, IN municipality_id int, IN district int, IN section int)
            BEGIN
                            ...
                            SELECT c_casillas.id, 
                                ...
                                group by c_casillas.seccion order by c_casillas.seccion asc, c_casillas.dtto_loc asc, c_casillas.id_municipio asc
                            ');
