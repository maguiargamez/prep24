                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    <div class="d-flex flex-column">
                        <div class="d-flex align-items-center mb-1">
                            <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bold me-3">Beneficios</a>
                        </div>
                ...
                <div class="d-flex flex-wrap justify-content-start">
                    <div class="d-flex flex-wrap">
                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                            ...
                            <div class="fw-semibold fs-6 text-gray-400">Total de Beneficios</div>
                        </div>
                        ...
                        {{--@foreach ($options["data"] as $datos)
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="fw-semibold fs-6 text-gray-400">Plan {{ $datos->type }}</div>
                            </div>
                        @endforeach--}}
