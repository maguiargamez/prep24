        ...
        <div class="card">
            <div class="card-body p-5 px-lg-19 py-lg-16">
                ...
                <div class="row g-10 mb-15">
                    ...
                    <h2 class="fs-2x text-info mb-2">Sección</h2>
                    ...
                    <h2 class="text-darko mb-2">Detalle de votos por Sección</h2>

                    <x-select wire:model="localDistrictKey" :options="$districts" placeholder="Seleccionar" id="localDistrictKey"></x-select>

                    <div class="col-lg-12" wire:loading wire:target="localDistrictKey">
                        <x-loaders.loading-form></x-loaders.loading-form>
                    </div>
                    <div wire:loading.remove wire:target="localDistrictKey" class="table-responsive">
                        <table class="table table-row-bordered table-hover table-row-gray-600">
                            ...
                            <tbody >
                                @foreach ($sections as $section)
                                    <tr>
                                        <td class="fw-bold text-gray-800">Sección {{ $section->section }}</td>

                                        @foreach ($candidates as $candidate)
                                            <td class="min-w-200px text-center">
                                                {{ number_format($section->results[$candidate->id]) }}
                                            </td>
                                        @endforeach

                                        <td class="min-w-200px text-center">
                                            {{ number_format($section->results['total']) }}
                                        </td>   
                                    </tr>     
                                @endforeach
                            </tbody>
