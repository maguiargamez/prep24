        ...
        <div class="card mb-5">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center position-relative my-1 mt-10">                        
                    ...
                    <input type="text" wire:model='search' name="search" class="form-control form-control-solid w-450px ps-15" placeholder="Buscar municipio...">
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ( $votosCandidatosSecciones as $key=> $value )                                
                                ...
                                <tr class="text-gray-700 border-bottom-1 border-gray-200 ">                                    
                                    <td>
                                        <span class="text-gray-800 h5">{{ $value->seccion }}</span>
                                    </td>
