    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{ route('candidates.create') }}" type="button" class="btn btn-sm btn-primary me-3">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" wire:model='search' name="search" data-kt-customer-table-filter="search" class="form-control form-control-solid w-450px ps-15" placeholder="Buscar por nombre del candidato...">
                    </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <table class="table table-striped table-rounded table-row-bordered border gy-7 gs-7">
                        ...
                        <thead>
                            ...
                            <tr class="fw-semibold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                ...
                                <th class="min-w-125px sorting" tabindex="0" rowspan="1" colspan="1" >Candidato</th>
                                <th class="min-w-125px sorting" tabindex="0" rowspan="1" colspan="1" >Elección</th>
                                ...
                                <tr class="odd">
                                    ...
                                    <td class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="#">
                                                <div class="symbol-label">
                                                    @if($item->photo!=null)
                                                        <img src="{{ asset($item->photo) }}" class="w-100">
                                                    @else
                                                        <img src="{{ asset('img/candidatos/default.png') }}" class="w-100">
                                                    @endif
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span>{{ $item->partyCoalition->name }}</span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown">
                                        ...
                                        <a class="btn btn-icon btn-bg-warning btn-active-color-default btn-sm" href="{{ route('candidates.edit', $item) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
...
@push('scripts')
    ...
    Livewire.on('deleteRecord', itemId => {
        Swal.fire({
            ...
            if (result.isConfirmed) {            
                Livewire.emitTo('inventory.candidates.candidates','destroy', itemId);
                Swal.fire(
                    'Eliminado',
    ...
    Livewire.on('deleteRecords', ()=> {
        Swal.fire({
            ...
            if (result.isConfirmed) {            
                Livewire.emitTo('inventory.candidates.candidates','destroySelected');
                Swal.fire(
                    'Eliminado',
