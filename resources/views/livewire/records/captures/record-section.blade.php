        ...
        <div id="kt_app_content_container" class="app-container container-xxl">               
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-15">
                        <h1 class="fs-2x text-dark mb-6">Distrito {{ $section->district }}.  
                            <span class="text-gray-400 fw-bold">{{ $section->section2 }}</span>  
                        </h1> 
                            ...
                            <table class="table table-striped table-rounded table-row-bordered border gy-7 gs-7" id="kt_table_widget_4_table">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                        ...
                                        <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 50px;">Acciones</th>
                                    </tr>
                                </thead>
                                    ...
                                    @foreach($items as $item)
                                        ...
                                        <tr class="border-dashed border-bottom-2 border-gray-300">
                                            ...
                                            <td style="padding-left: 10px">
                                                <a href="{{ route('records.section.index', $item) }}" class="text-gray-700 text-hover-primary">{{ $item->section." ".$item->type_key }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td align="right">
                                            <a class="btn btn-icon btn-bg-warning btn-active-color-default btn-sm" href="{{ route('records.polling-place.create', $item) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
