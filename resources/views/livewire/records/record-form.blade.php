                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input disabled="disabled" value="{{ ($pollingPlace->received_ballots+$pollingPlace->special_ballots==$pollingPlace->taken_ballots) ? "SI" : "NO"; }}" type="text" class="form-control" placeholder="name@example.com"/>
